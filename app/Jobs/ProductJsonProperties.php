...
class ProductJsonProperties implements ShouldQueue
{
    ...
    {
        // и после того как он создан, нужно сгенерировать характеристики в Json_properties будет
        // достаточно массива с ключём с названием характеристики и значением. Поэтому из
